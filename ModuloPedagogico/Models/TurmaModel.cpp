...
TurmaModel::TurmaModel(RestAccessManager *restAccessManager, QObject *parent)
    : QObject{parent}
    , restAccessManager(restAccessManager)
{
    connect(this, &TurmaModel::dataReceived, this, &TurmaModel::processResponseData);
}

void TurmaModel::getTurmas(QString url, QUrlQuery parameters)
{
...
QString TurmaModel::defineEscolaridade(const QString &nomeTurma)
{
...
void TurmaModel::processResponseData(std::optional<QByteArray> data)
{
